...
it('shows the player name, chips, and stat labels', () => {
  render(<PlayerProfileModal player={player} tableRole={null} onClose={vi.fn()} />);
...
it('calls onClose when the close button is clicked', () => {
  const onClose = vi.fn();
  render(<PlayerProfileModal player={player} tableRole={null} onClose={onClose} />);
...
it('calls onClose when the overlay is clicked', () => {
  const onClose = vi.fn();
  const { container } = render(<PlayerProfileModal player={player} tableRole={null} onClose={onClose} />);
